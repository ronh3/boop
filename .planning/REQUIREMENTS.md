...
- [x] **STATE-03**: Runtime trace, status, and dashboard surfaces report canonical owned-state values when debugging targeting, movement, pull, gold, diag, flee, queue, and gag behavior.
