...
- `boop_ui_spec.lua`
  Confirms the bare `boop` command shows the main control dashboard with mode/blocker guidance, plus the mode, presets, theme, party dashboard, and roster manager views.
- `boop_stats_spec.lua`
