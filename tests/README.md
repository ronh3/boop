...
Attack profile tests cover Magi Scintilla and Staff-gated Dissolution preference selection while preserving Horripilation as the default, Blademaster Multislash preference and Drawslash fallback, class/spec-scoped temporary preference precedence and reset, class-agnostic session shield modes, and configurable rage-pool threshold behavior including shieldbreak and free-rage exemptions.
