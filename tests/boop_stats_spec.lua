...
describe("boop stats", function()
  ...
  it("shows a concise stats help page", function()
    ...
    assert.are.equal("    boop stats compare [left] [right]             -> compare two scopes; default trip vs lasttrip", messages[21])
    assert.are.equal("    boop help stats                               -> workflow help for stats", messages[23])
  end)
